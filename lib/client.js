window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function createPanelState() {
			const source = (0, _deepseek_ai_dsh_client_store.createSnapshotStore)({
				open: false,
				position: null
			});
			return {
		...
		const CSS = [
			...
			".dr-badge { display: inline-block; margin-right: 6px; padding: 1px 8px; border-radius: 999px; border: 1px solid var(--dsw-alias-border-l2); background: var(--dsw-alias-bg-layer-2); color: var(--dsw-alias-label-secondary); font-size: 11px; }",
			...
			".dr-section-head:hover { background: var(--dsw-alias-interactive-bg-hover); }",
			...
			".dr-tag { display: inline-block; margin-right: 6px; margin-top: 2px; padding: 0 6px; border-radius: 4px; border: 1px solid var(--dsw-alias-border-l2); background: var(--dsw-alias-bg-layer-2); color: var(--dsw-alias-label-secondary); font-size: 11px; }",
			".dr-conf-author { color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-state-success-secondary); background: var(--dsw-alias-state-success-tertiary); }",
			".dr-conf-fact { color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-state-business-primary); background: var(--dsw-alias-state-business-tertiary); }",
			".dr-conf-infer { color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-state-warn-secondary); background: var(--dsw-alias-state-warn-tertiary); }",
			".dr-conf-unknown { color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-state-error-secondary); background: var(--dsw-alias-bg-layer-2); }",
			...
			".dr-composer-btn { display: inline-flex; align-items: center; justify-content: center; min-width: 30px; min-height: 30px; flex-shrink: 0; background: none; border: 1px solid var(--dsw-alias-border-l1); border-radius: 8px; cursor: pointer; color: var(--dsw-alias-label-secondary); font-size: 14px; }",
			".dr-composer-btn:hover { color: var(--dsw-alias-label-primary); border-color: var(--dsw-alias-border-l2); background: var(--dsw-alias-interactive-bg-hover); }",
			".dr-panel { pointer-events: auto; position: fixed; top: 56px; right: 16px; width: 420px; max-width: calc(100vw - 32px); max-height: 86vh; overflow-y: auto; z-index: 200; display: flex; flex-direction: column; gap: 8px; background: var(--dsw-alias-bg-layer-3); border: 1px solid var(--dsw-alias-border-l2); border-radius: 12px; box-shadow: var(--dsw-shadow-lv3); padding: 12px; font-size: 13px; color: var(--dsw-alias-label-primary); }",
			...
			".dr-input:hover { border-color: var(--dsw-alias-border-l2); }",
			".dr-input::placeholder { color: var(--dsw-alias-label-secondary); opacity: 1; }",
			...
			".dr-depth:hover, .dr-export:hover { color: var(--dsw-alias-label-primary); background: var(--dsw-alias-interactive-bg-hover); border-color: var(--dsw-alias-border-l2); }",
			".dr-depth-on, .dr-export-on { color: var(--dsw-alias-state-business-primary); border-color: var(--dsw-alias-state-business-primary); background: var(--dsw-alias-interactive-bg-active); font-weight: 600; }",
			".dr-submit { background: var(--dsw-alias-button-primary-fill); color: var(--dsw-alias-label-primary-foreground); border: none; border-radius: 8px; padding: 7px 12px; cursor: pointer; font-size: 13px; font-weight: 600; }",
			".dr-submit:not(:disabled):hover { background: var(--dsw-alias-button-primary-hover); }",
			".dr-submit:disabled { background: var(--dsw-alias-button-primary-dimmed); color: var(--dsw-alias-label-secondary); cursor: not-allowed; }",
			...
			".dr-preflight:not(:disabled):hover { border-color: var(--dsw-alias-state-business-primary); color: var(--dsw-alias-state-business-primary); background: var(--dsw-alias-interactive-bg-hover); }",
			".dr-preflight:disabled { border-color: var(--dsw-alias-border-l2); background: var(--dsw-alias-bg-layer-2); color: var(--dsw-alias-label-tertiary); cursor: not-allowed; }",
			...
			".dr-history-head:hover { background: var(--dsw-alias-interactive-bg-hover); }",
			...
			".dr-history-reread:hover { border-color: var(--dsw-alias-state-business-primary); background: var(--dsw-alias-interactive-bg-hover); }",
			".dr-composer-btn:focus-visible, .dr-close:focus-visible, .dr-input:focus-visible, .dr-section-head:focus-visible, .dr-depth:focus-visible, .dr-export:focus-visible, .dr-submit:focus-visible, .dr-preflight:focus-visible, .dr-history-head:focus-visible, .dr-history-reread:focus-visible { outline: 2px solid var(--dsw-alias-state-business-primary); outline-offset: 2px; }"
		].join("\n");
		...
		function Panel(props) {
			...
			const moveActiveDrag = (pointerId, clientX, clientY) => {
				const active = dragRef.current;
				if (active === null || active.pointerId !== pointerId) return;
				const panel = panelRef.current;
				const header = headerRef.current;
				if (panel === null || header === null) return;
				props.setPanelPosition(clampPosition(active.originLeft + clientX - active.startX, active.originTop + clientY - active.startY, panel.getBoundingClientRect().width, header.getBoundingClientRect().height));
			};
